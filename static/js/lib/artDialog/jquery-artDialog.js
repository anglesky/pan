...
artDialog.fn = artDialog.prototype = {
	...
	reset_title_length:function(){
		...
		var DOM = this.DOM,
			...
			title_str = title.attr('data-title'),
			default_width = 150,	//其他占用
...
artDialog.defaults = {								
	...
	ico:'./static/images/file_icon/file_16/file.png',//默认标题小图标
