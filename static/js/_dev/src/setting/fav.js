define(function(require, exports) {
    ...
    var make_list = function(favData,setting){
        ...
        if (setting && setting.substring(0,4) == 'fav&') {//如果是添加收藏
            ...
            "       <a href='javascript:void(0)' class='button addexit'>"+LNG.button_cancel+"</a>"+
            "   </td>"+
            "</tr>";
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if (data.code){
                    ...
                    FrameCall.father('ui.tree.refresh_fav','""');
                }
            }
        });
    };
