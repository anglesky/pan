...
$L= array(
	...
	"space_size"				=> "空間大小",
	"space_size_use"			=> "空間使用",
	"space_is_full"				=> "空間已滿,請聯系管理員擴充空間！",
	"system_open_true_path"		=> "成功在檔案管理中打開！",
	"group_role_error"			=> "權限角色錯誤(無權限設定)",
	"group_role_error_admin"	=> "權限角色錯誤(權限不夠)",
	...
	"config_save_error_file"	=> "設定儲存失败,kod目录需要有写权限!",
	...
	"copyright_desc"  			=> "這是壹款備受好評的web文檔管理系統，妳可以用它來做內部文檔管理或共用、也可以用來管理服務器上的網站，取代Ftp
	...
	"cute_past_success"          => "<b>剪切操作完成</b>(原始檔案被刪除,剪貼板清除)",
	"zip_success"                => "壓縮完成",
	"not_zip"                    => "不是壓縮檔",
	"zip_null"                   => "無選擇的檔或目錄",
	"unzip_success"              => "解壓完成",
