		...
		<div class='frame-left'>
			...
			<div class="bottom_box">
				...
				<div class="box_content">
					<a href="javascript:ui.path.list('{user_recycle}');" 
						class="cell menuRecycleButton"><i class="font-icon icon-trash"></i><span><?php echo $L['recycle'];?></span></a>
					<a href="javascript:ui.path.list('{user_share}:<?php echo $_SESSION['kod_user']['user_id'];?>/');" 
						class="cell"><i class="font-icon icon-share-sign"></i><span><?php echo $L['my_share'];?></span></a>
			...
			<div class="frame-right-main">
				<div class="tools">
					<div class="tools-left">
						...
						<div class="admin_real_path hidden fl-left">
...
<?php if(isset($_GET['type'])){?>
	...
	.frame-header{top:0;}
	.frame-main{top:50px;bottom:0px;}
	...
	<?php if($_GET['type']=="file_list"){?>
		...
		.frame-main .frame-left,.frame-main .frame-resize{display:none;}
		.frame-main .frame-right{left:0px;}
		.frame-main .frame-right .bodymain{top:34px;}
		.frame-main{top:0px;}
