...
<body style="overflow: hidden;" oncontextmenu="return core.contextmenu();" id="page_desktop">
	...
	<div class='bodymain html5_drag_upload_box desktop'>
		<img class="background" src="<?php echo $wall;?>"/>
		<div class="fileContiner fileList_icon hidden">
			<div class="file systemBox menuDefault" 
			data-app="<?php echo base64_encode('{"type":"app","width":"","height":"","content":"core.explorer(\'\',LNG.my_computer);"}');?>" data-path="">
			...
			data-app="<?php echo base64_encode('{"type":"app","width":"","height":"","content":"core.setting();"}');?>" data-path="">
			...
			data-app="<?php echo base64_encode('{"type":"app","width":"","height":"","content":"core.appStore();"}');?>" data-path="">
